...
class Ai extends React.Component {
  ...
  render() {
    return (
      <div>
        <SpaceDisplay ref={this.displayRef} circles={[this.simulator.a, this.simulator.b, this.simulator.c]} focusedOnCircle={this.simulator.c} fuelPercentage={this.simulator.c.fuel} />
        <div>
          <label>length
